...
- [`Json`](src\integrations\supabase\types.ts#L1) (type)
- [`Database`](src\integrations\supabase\types.ts#L9) (type)
- [`Tables`](src\integrations\supabase\types.ts#L169) (type)
- [`TablesInsert`](src\integrations\supabase\types.ts#L198) (type)
- [`TablesUpdate`](src\integrations\supabase\types.ts#L223) (type)
- [`Enums`](src\integrations\supabase\types.ts#L248) (type)
